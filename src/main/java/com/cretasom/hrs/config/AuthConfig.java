package com.cretasom.hrs.config;
...
public class AuthConfig {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		return http.csrf(csrf -> csrf.disable()).authorizeHttpRequests(requests -> requests
				.requestMatchers("/login", "/validatelogin/**", "/css/**", "image/**", "/hotel/fetch/**",
						"/hotel/fetch-hotels/**", "/logout")
				.permitAll().requestMatchers("/hotel/**", "/user/**").hasRole("ADMIN").requestMatchers("/rating/**")
